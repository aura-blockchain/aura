...
replace github.com/cosmos/iavl => github.com/cosmos/iavl v1.2.2

replace github.com/bytedance/sonic => ./third_party/sonicstub

replace github.com/bytedance/sonic/loader => ./third_party/sonicstub/loader
