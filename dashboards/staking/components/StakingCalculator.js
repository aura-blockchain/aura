            ...
            <div class="calculator-panel">
                ...
                <form id="calculator-form">
                    <div class="form-group">
                        <label for="calc-amount">Staking Amount (AURA)</label>
                        <input
                            type="number"
                            id="calc-amount"
                            value="${this.amount}"
    ...
    renderResults(results = null) {
        ...
        return `
            ...
            <div class="result-item">
                ...
                <div class="result-value">${formatAmount(results.total * 1e6)} AURA</div>
                <div class="result-sub">Initial: ${formatAmount(this.amount * 1e6)} AURA</div>
            </div>

            <div class="result-item">
                <div class="result-label">Final Amount</div>
                <div class="result-value">${formatAmount(finalAmount * 1e6)} AURA</div>
                <div class="result-sub">+${formatPercent((results.total / this.amount) * 100)} gain</div>
            </div>

            <div class="result-item">
                <div class="result-label">Daily Rewards</div>
                <div class="result-value">${formatAmount(results.daily * 1e6)} AURA</div>
                <div class="result-sub">${formatPercent(this.apy / 365)} daily rate</div>
            </div>

            <div class="result-item">
                <div class="result-label">Weekly Rewards</div>
                <div class="result-value">${formatAmount(results.weekly * 1e6)} AURA</div>
            </div>

            <div class="result-item">
                <div class="result-label">Monthly Rewards</div>
                <div class="result-value">${formatAmount(results.monthly * 1e6)} AURA</div>
            </div>

            <div class="result-item">
                <div class="result-label">Yearly Rewards</div>
                <div class="result-value">${formatAmount(results.yearly * 1e6)} AURA</div>
            ...
            ${this.compound ? `
                <div class="result-item">
                    ...
                    <div class="result-value">+${formatAmount((results.total - this.api.calculateRewards(this.amount, this.apy, this.days).total) * 1e6)} AURA</div>
