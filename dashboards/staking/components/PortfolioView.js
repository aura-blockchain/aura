...
export class PortfolioView {
    ...
    async render(delegatorAddress) {
        ...
        try {
            ...
            const totalRewards = rewards.total.reduce((sum, r) =>
                r.denom === 'uaura' ? sum + r.amount : sum, 0
            );
            ...
            <div class="portfolio-summary">
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-value">${formatAmount(balance * 1e6)} AURA</div>
                    </div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-value">${formatAmount(totalDelegated * 1e6)} AURA</div>
                    </div>
                </div>
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-info">
                        ...
                        <div class="stat-value">${formatAmount(totalUnbonding * 1e6)} AURA</div>
                    </div>
                </div>
    ...
    renderDelegationItem(delegation, rewards) {
        ...
        const auraReward = validatorReward?.reward.find(r => r.denom === 'uaura');
            ...
            <div class="delegation-item">
                <div style="flex: 1;">
                    ...
                    <div style="font-size: 0.875rem; color: var(--text-secondary);">
                        Delegated: ${formatAmount(delegation.balance * 1e6)} AURA
                    </div>
                    ${rewardAmount > 0 ? `
                        <div style="font-size: 0.875rem; color: var(--success-color); margin-top: 0.25rem;">
                            <i class="fas fa-coins"></i> Rewards: ${formatAmount(rewardAmount * 1e6)} AURA
                        </div>
                    ` : ''}
                </div>
                    ...
                    <div class="delegation-item">
                        ...
                        <div style="text-align: right;">
                            <div style="font-weight: 600; color: ${h.action === 'Claim Rewards' ? 'var(--success-color)' : 'var(--text-primary)'};">
                                ${h.action === 'Claim Rewards' ? '+' : ''}${formatAmount(h.amount * 1e6)} AURA
                            </div>
                        </div>
                    </div>
                `).join('')}
