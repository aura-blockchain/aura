...
export class StakingAPI {
    ...
    async getBalance(address) {
        try {
            ...
            const auraBalance = response.balances.find(b => b.denom === 'uaura');
            return auraBalance ? parseFloat(auraBalance.amount) / 1e6 : 0;
        } catch (error) {
    ...
    getMockValidators() {
        return [
            {
                operatorAddress: 'auravaloper1abc123',
            ...
            {
                operatorAddress: 'auravaloper1def456',
            ...
            {
                operatorAddress: 'auravaloper1ghi789',
