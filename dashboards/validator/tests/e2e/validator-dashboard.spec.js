...
test.describe('Validator Dashboard E2E Tests', () => {
    ...
    test('should load dashboard homepage', async ({ page }) => {
        await expect(page.locator('h1')).toContainText('AURA Validator Dashboard');
    ...
    test('should add a new validator', async ({ page }) => {
        ...
        await page.fill('#newValidatorAddress', 'auravaloper1test123456789');
    ...
    test('should display validator statistics', async ({ page }) => {
        ...
        if (!hasValidators) {
            await page.click('#addValidatorBtn');
            await page.fill('#newValidatorAddress', 'auravaloper1test');
            await page.click('#confirmAddValidator');
        }
    ...
    test('should search delegations', async ({ page }) => {
        ...
        await page.fill('#delegationSearch', 'aura1');
    ...
    test('should persist validator selection', async ({ page }) => {
        ...
        await page.click('#addValidatorBtn');
        await page.fill('#newValidatorAddress', 'auravaloper1persist');
        await page.click('#confirmAddValidator');
        ...
        const hasValidator = options.some(opt => opt.includes('auravaloper1persist'));
