...
describe('ValidatorCard', () => {
    ...
    it('should render validator card with correct data', () => {
        ...
        expect(html).toContain('auravaloper1test');
    ...
    it('should format tokens correctly', () => {
        ...
        expect(card.formatTokens('1000000')).toContain('AURA');
        expect(card.formatTokens(null)).toBe('0 AURA');
    });
...
describe('DelegationList', () => {
    const mockDelegations = [
        {
            delegatorAddress: 'aura1delegator1',
            shares: '5000000000',
            pendingRewards: '10000',
            timestamp: '2024-01-01T00:00:00Z'
        },
        {
            delegatorAddress: 'aura1delegator2',
            shares: '3000000000',
            pendingRewards: '6000',
    ...
    it('should render delegation list with correct data', () => {
        ...
        expect(html).toContain('aura1delegator1');
        expect(html).toContain('aura1delegator2');
    ...
    it('should filter delegations by search term', () => {
        ...
        expect(list.filteredDelegations[0].delegatorAddress).toBe('aura1delegator1');
    });
});
