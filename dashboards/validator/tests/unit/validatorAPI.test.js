...
describe('ValidatorAPI', () => {
    ...
    describe('getValidatorInfo', () => {
        it('should fetch and format validator information', async () => {
            ...
            const result = await ValidatorAPI.getValidatorInfo('auravaloper1test');

            expect(result.address).toBe('auravaloper1test');
        ...
        it('should fetch and format delegations', async () => {
            const mockDelegations = {
                delegation_responses: [
                    {
                        delegation: {
                            delegator_address: 'aura1delegator1',
                            shares: '1000000'
                        }
                    },
                    {
                        delegation: {
                            delegator_address: 'aura1delegator2',
                            shares: '2000000'
                        }
                    }
                ]
            ...
            const result = await ValidatorAPI.getDelegations('auravaloper1test');

            expect(result).toHaveLength(2);
            expect(result[0].delegatorAddress).toBe('aura1delegator1');
    ...
    describe('getRewards', () => {
        it('should fetch validator rewards', async () => {
            ...
            const result = await ValidatorAPI.getRewards('auravaloper1test');
    ...
    describe('Helper methods', () => {
        it('should calculate uptime correctly', async () => {
            ...
            const uptime = await ValidatorAPI.calculateUptime('auravaloper1test');
    ...
    describe('Mock data generators', () => {
        it('should generate mock validator info', () => {
            const mock = ValidatorAPI.getMockValidatorInfo('auravaloper1test');

            expect(mock.address).toBe('auravaloper1test');
        ...
        it('should generate mock delegations', () => {
            ...
            expect(mock[0].delegatorAddress).toMatch(/^aura1/);
        });
