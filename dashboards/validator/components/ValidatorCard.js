        ...
        return `
            <div class="validator-card">
                ...
                <div class="validator-actions">
                    ...
                    <button class="btn btn-secondary" onclick="window.open('https://explorer.aura.network/validators/${address}', '_blank')">
