# AURA Validator Dashboard

A comprehensive, real-time dashboard for monitoring and managing validators on the AURA blockchain.
...
- Access to AURA blockchain endpoints (LCD and WebSocket)
...
2. Enter the validator address (e.g., `auravaloper1...`)
...
**Note:** Commission updates require transaction signing and are not available directly in the web interface. Use the AURA CLI:

```bash
aurad tx staking edit-validator --commission-rate 0.05 --from validator
```
