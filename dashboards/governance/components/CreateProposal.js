...
class CreateProposal {
                    ...
                    <form id="proposalForm" class="proposal-form">
                        ...
                        <div id="communitySpendFields" class="form-section hidden">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="recipientAddress" placeholder="aura1...">
                            </div>

                            <div class="form-group">
                                <label for="spendAmount">Amount (AURA)</label>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                <label for="initialDeposit">
                                    Deposit Amount (AURA) <span class="required">*</span>
                                </label>
                                <input
                                    type="number"
                                    id="initialDeposit"
                                    ...
                                    min="1"
                                    step="0.000001"
                                    placeholder="Minimum: 10,000 AURA"
                                >
                                <small class="form-hint">
                                    Minimum deposit: 10,000 AURA. Your deposit will be returned if the proposal passes.
                                </small>
                            </div>
            ...
            if (recipient && amount) {
                additionalInfo = `
                    <div class="preview-params">
                        ...
                        <strong>Amount:</strong> ${amount} AURA
                    </div>
                `;
            }
        }
        ...
        previewContainer.innerHTML = `
            <div class="preview-content">
                ...
                <div class="preview-deposit">
                    <strong>Initial Deposit:</strong> ${deposit ? parseFloat(deposit).toLocaleString() + ' AURA' : 'Not specified'}
                </div>
            </div>
        `;
    }
    ...
    async handleSubmit() {
        ...
        if (parseFloat(deposit) < 10000) {
            this.app.showError('Minimum deposit is 10,000 AURA');
            return;
        }
