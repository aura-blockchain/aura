        ...
        return `
            <div class="progress-container">
                ...
                <div class="progress-text">
                    ${this.formatVotingPower(currentDeposit)} / ${this.formatVotingPower(minDeposit)} AURA
    ...
    renderDepositsList(deposits) {
        ...
        return deposits.map(deposit => `
            <div class="deposit-item">
                ...
                <div class="deposit-amount">${this.formatVotingPower(deposit.amount[0].amount)} AURA</div>
    ...
    async submitDeposit() {
        ...
        try {
            await this.api.deposit(
                ...
                [{ denom: 'aura', amount: String(parseInt(amount) * 1000000) }],
