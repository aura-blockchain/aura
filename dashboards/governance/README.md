# AURA Governance Portal

A comprehensive, production-ready governance portal for the AURA blockchain, enabling community participation in on-chain governance through proposal creation, voting, and analytics.
...
- Access to AURA blockchain RPC/REST endpoints
...
4. Fill in required fields:
   ...
   - Initial deposit (minimum 10,000 AURA)
...
{
  deposit: {
    min_deposit: [{ denom: "aura", amount: "10000000" }], // 10,000 AURA
...
Please follow AURA blockchain contribution guidelines when submitting improvements.
...
- GitHub Issues: [AURA Repository]
- Documentation: [AURA Docs]
