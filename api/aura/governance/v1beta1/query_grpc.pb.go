...
func (UnimplementedQueryServer) TokenLocks(context.Context, *QueryTokenLocksRequest) (*QueryTokenLocksResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method TokenLocks not implemented")
}
func (UnimplementedQueryServer) VetoRequests(context.Context, *QueryVetoRequestsRequest) (*QueryVetoRequestsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method VetoRequests not implemented")
}
func (UnimplementedQueryServer) SnapshotVotes(context.Context, *QuerySnapshotVotesRequest) (*QuerySnapshotVotesResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method SnapshotVotes not implemented")
}
