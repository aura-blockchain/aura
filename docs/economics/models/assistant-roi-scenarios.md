...
## Core Assumptions
- **Base PoI reward:** 6 AURA per verified human (per tokenomics RFC); sample scenarios assume assistants earn 40–65% of that depending on tier.
- **AURA reference price:** $0.50 for planning purposes.
...
See `assistant-roi-scenarios.csv` for full figures (IR/day, AURA/day, USD/day, OpEx, CapEx, breakeven months).
...
## Next Steps
1. Replace placeholder AURA price with live market feeds once token lists.
