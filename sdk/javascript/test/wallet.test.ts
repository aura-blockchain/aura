...
describe('AuraWallet', () => {
  describe('generateMnemonic', () => {
    it('should generate a valid 24-word mnemonic', () => {
      ...
      expect(AuraWallet.validateMnemonic(mnemonic)).toBe(true);
    });
  });
  ...
  describe('validateMnemonic', () => {
    ...
    it('should reject invalid mnemonics', () => {
      expect(AuraWallet.validateMnemonic('invalid mnemonic phrase')).toBe(false);
      expect(AuraWallet.validateMnemonic('')).toBe(false);
    });
  });
