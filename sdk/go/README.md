...
Go SDK helpers and utilities for AURA blockchain development.

## Overview

This package provides helper functions and utilities that complement the core AURA blockchain codebase. While the main blockchain code is in the root `github.com/aura-chain/paw` module, this SDK provides convenient wrappers and utilities for building applications.
...
```bash
go get github.com/aura-chain/paw/sdk/go
```
...
```go
import (
    pawclient "github.com/aura-chain/paw/sdk/go/client"
    "github.com/aura-chain/paw/sdk/go/helpers"
)
...
msg := banktypes.NewMsgSend(
    fromAddr,
    toAddr,
    sdk.NewCoins(sdk.NewCoin("uaura", sdk.NewInt(1000000))),
)
...
```go
coin := sdk.NewCoin("uaura", sdk.NewInt(1500000))

// Format with 6 decimals
formatted := helpers.FormatCoin(coin, 6)
// Output: "1.500000 uaura"
```
...
```go
// Validate address
err := helpers.ValidateAddress("aura1...", "paw")
...
import (
    "testing"
    sdktesting "github.com/aura-chain/paw/sdk/go/testing"
)
