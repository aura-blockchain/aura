...
func SetupTestClient(t *testing.T, config TestConfig) *auraclient.Client {
	t.Helper()

	clientConfig := auraclient.Config{
	...
	client, err := auraclient.NewClient(clientConfig)
...
func CreateTestWallet(t *testing.T, client *auraclient.Client, name string) (string, sdk.AccAddress) {
	t.Helper()
...
func AssertBalanceGreaterThan(t *testing.T, client *auraclient.Client, address, denom string, minAmount math.Int) {
	t.Helper()
...
func WaitForNextBlock(t *testing.T, client *auraclient.Client) {
	t.Helper()
...
func FundAccount(t *testing.T, client *auraclient.Client, fromName, toAddress string, amount sdk.Coin) {
	t.Helper()
