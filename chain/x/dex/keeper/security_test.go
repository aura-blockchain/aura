...
func TestSecurityParamsDefaults(t *testing.T) {
	...
	require.Equal(t, math.LegacyNewDecWithPrec(20, 2).String(), params.MaxTradeSizePercent.String())
	require.Equal(t, math.LegacyNewDecWithPrec(10, 0).String(), params.MaxPriceImpactPercent.String())
	...
	require.Equal(t, math.NewInt(1000_000000).String(), params.MinPoolCreationLiquidity.String())
	require.Equal(t, uint64(5), params.MinLiquidityBlocks)
	require.Equal(t, int64(60), params.WashTradeMinInterval)
	require.Equal(t, math.NewInt(1_000000).String(), params.MinTradeAmount.String())
