...
func DefaultSecurityParams() SecurityParams {
	return SecurityParams{
		...
		DailyWithdrawalLimit:         math.NewInt(50000000000), // 50,000 tokens
		CircuitBreakerEnabled:        true,
		MaxHourlyVolume:              math.NewInt(500000000000), // 500,000 tokens/hour
		...
		FixedTransferFee:             math.NewInt(100000), // 0.1 token
