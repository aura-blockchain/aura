...
func TestSecurityFeatureDefaults(t *testing.T) {
	...
	require.True(t, params.SlashFractionInvalidProof.LTE(sdk.NewDecWithPrec(10, 2)), "slash fraction should be <= 10%")
	require.True(t, params.SlashFractionDoubleSign.LTE(sdk.NewDecWithPrec(20, 2)), "slash fraction should be <= 20%")
...
func TestCircuitBreakerLogic(t *testing.T) {
	...
	require.True(t, maxTransfers.GT(sdk.NewInt(5)), "should allow at least 5 max transfers per hour")
}
...
func TestWithdrawalLimitRatios(t *testing.T) {
	...
	require.True(t, ratio.GT(sdk.NewInt(1)), "daily limit should allow multiple max transfers")
	require.True(t, ratio.LT(sdk.NewInt(1000)), "daily limit should not be too high")
}
...
func TestFeeCalculation(t *testing.T) {
	...
	testCases := []struct {
		...
		{"small", sdk.NewInt(1000000)},           // 1 token
		{"medium", sdk.NewInt(100000000)},        // 100 tokens
		{"large", sdk.NewInt(10000000000)},       // 10,000 tokens
		{"very_large", sdk.NewInt(100000000000)}, // 100,000 tokens
	}
