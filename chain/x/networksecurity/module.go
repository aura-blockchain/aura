...
// RegisterGRPCGatewayRoutes registers the gRPC Gateway routes for the networksecurity module.
func (AppModuleBasic) RegisterGRPCGatewayRoutes(clientCtx client.Context, mux *runtime.ServeMux) {
	if err := networksecuritypb.RegisterQueryHandlerClient(context.Background(), mux, networksecuritypb.NewQueryClient(clientCtx)); err != nil {
		panic(fmt.Errorf("failed to register networksecurity query handler: %w", err))
	}
}
