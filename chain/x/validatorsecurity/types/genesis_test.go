		...
		},
		{
			...
			genesis: &types.GenesisState{
				Params: types.ValidatorSecurityParams{
					DoubleSignSlashFraction: math.LegacyNewDec(-1), // Invalid
					DowntimeSlashFraction:   types.DefaultDowntimeSlashFraction,
					SignedBlocksWindow:      types.DefaultSignedBlocksWindow,
					MinSignedPerWindow:      types.DefaultMinSignedPerWindow,
					DowntimeJailDuration:    types.DefaultDowntimeJailDuration,
					MinimumStakeAmount:      types.DefaultMinimumStakeAmount,
				},
				Validators:          []types.ValidatorSecurityInfo{},
				DoubleSignEvidences: []types.DoubleSignEvidence{},
				DowntimeInfractions: []types.DowntimeInfraction{},
				...
				DoubleSignEvidences: []types.DoubleSignEvidence{
					{
						...
						VoteA:            []byte("vote_a"),
						VoteB:            []byte("vote_b"),
						SlashFraction:    math.LegacyNewDecWithPrec(5, 2),
					},
				},
				DowntimeInfractions: []types.DowntimeInfraction{},
				Alerts:              []types.ValidatorAlert{},
