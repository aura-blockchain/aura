...
func setupModule(t *testing.T) (AppModule, *keeper.Keeper, sdk.Context, codec.JSONCodec) {
	...
	k := keeper.NewKeeper(binaryCodec, storeKey, nil, nil, nil)
...
func TestAppModuleBasic_ValidateGenesis(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			name:    "empty genesis",
			genesis: json.RawMessage(""),
			wantErr: false, // governance allows empty genesis
		},
		{
			name:    "invalid json",
...
func TestAppModule_GetTxCmd(t *testing.T) {
	basic := AppModuleBasic{}
	cmd := basic.GetTxCmd()
...
func TestAppModule_GetQueryCmd(t *testing.T) {
	basic := AppModuleBasic{}
