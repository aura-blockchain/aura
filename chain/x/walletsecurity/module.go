...
func (q *QueryServerImpl) GetHardwareWallet(
	...
	q.keeper.Logger(ctx).Info("unmarshaling hardware wallet config")
...
func (q *QueryServerImpl) GetMultiSigWallet(
	...
	q.keeper.Logger(ctx).Info("unmarshaling multi-sig wallet")
...
func (q *QueryServerImpl) GetPendingMultiSigTx(
	...
	q.keeper.Logger(ctx).Info("unmarshaling pending multi-sig tx")
...
func (q *QueryServerImpl) GetSocialRecoveryConfig(
	...
	q.keeper.Logger(ctx).Info("unmarshaling social recovery config")
...
func (q *QueryServerImpl) GetRecoveryRequest(
	...
	q.keeper.Logger(ctx).Info("unmarshaling recovery request")
...
func (q *QueryServerImpl) GetSpendingLimit(
	...
	q.keeper.Logger(ctx).Info("unmarshaling spending limit")
...
func (q *QueryServerImpl) GetSessionConfig(
	...
	q.keeper.Logger(ctx).Info("unmarshaling session config")
...
func (q *QueryServerImpl) GetSecurityMetrics(
	...
	q.keeper.Logger(ctx).Info("unmarshaling security metrics")
...
func (q *QueryServerImpl) GetDomainVerification(
	...
	q.keeper.Logger(ctx).Info("unmarshaling domain verification")
...
func (q *QueryServerImpl) GetDustFilter(
	...
	q.keeper.Logger(ctx).Info("unmarshaling dust filter")
