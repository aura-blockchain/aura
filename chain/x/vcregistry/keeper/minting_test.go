...
func TestValidateMintEligibility_RateLimitExceeded(t *testing.T) {
	...
	for i := 0; i < 5; i++ {
		keeper.IncrementMintCount(userAddr)
	}
...
func TestMintVC_Success(t *testing.T) {
	...
	// Register DID
	keeper.RegisterDID(userDID, userAddr, []*vcregistrypb.VerificationMethod{}, "")

	// Test
	metadata := map[string]string{
		"issued_at": "test",
	}
	vcID, err := keeper.MintVC(userAddr, userDID, vcType, "", metadata)
	...
	storedVC, ok := keeper.GetVCRecord(vcID)
	assert.True(t, ok)
...
func TestMintVC_NotEligible(t *testing.T) {
	...
	// Test
	vcID, err := keeper.MintVC(userAddr, userDID, vcType, "", map[string]string{})
...
func TestValidateMintEligibility_InvalidHolderAddress(t *testing.T) {
	...
	// Test
	eligible, _, err := keeper.ValidateMintEligibility("", vcType)
...
func TestMintVC_InvalidHolderAddress(t *testing.T) {
	...
	// Test
	vcID, err := keeper.MintVC("", userDID, vcType, "", map[string]string{})
...
func TestMintVC_InvalidDID(t *testing.T) {
	...
	// Test
	vcID, err := keeper.MintVC(userAddr, "", vcType, "", map[string]string{})
...
func TestMintVC_InvalidVCType(t *testing.T) {
	...
	// Test
	vcID, err := keeper.MintVC(userAddr, userDID, vcregistrypb.VCType_VC_TYPE_UNSPECIFIED, "", map[string]string{})
