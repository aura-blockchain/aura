...
func (AppModuleBasic) RegisterGRPCGatewayRoutes(clientCtx client.Context, mux *runtime.ServeMux) {
	if err := cryptoproto.RegisterQueryHandlerClient(context.Background(), mux, cryptoproto.NewQueryClient(clientCtx)); err != nil {
		panic(fmt.Errorf("failed to register cryptography query handler: %w", err))
	}
}
