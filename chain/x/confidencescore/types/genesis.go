...
func ValidateGenesisState(state *confidencescorepb.GenesisState) error {
	...
	if state.Params != nil {
		...
		params := Params{
			...
			VelocityBonusMultipliers: state.Params.VelocityBonusMultipliers,
			ArenaMultipliers:         state.Params.ArenaMultipliers,
			...
			JackpotMultipliers:       state.Params.JackpotMultipliers,
