...
{
  "suggestions": [
    "AIXN1234567890abcdef...",
    "AIXN9876543210fedcba..."
  ]
}
```
...
Content-Disposition: attachment; filename=transactions_AIXN....csv

txid,timestamp,from,to,amount,fee,type
abc123...,2024-01-15T10:30:45,AIXN...,TXAI...,100.0,1.0,transfer
def456...,2024-01-15T10:25:30,TXAI...,AIXN...,50.0,0.5,transfer
```
...
# Export
csv = client.export_transactions("AIXN...")
print(csv)
```
...
# Export transactions
curl http://localhost:8082/api/export/transactions/AIXN... > transactions.csv
...
2. Addresses must start with AIXN or TXAI
