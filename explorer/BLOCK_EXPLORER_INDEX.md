...
- [x] Address search (AIXN/TXAI prefix)
...
👉 **`src/aixn/BLOCK_EXPLORER_README.md`**
...
└── src/aixn/BLOCK_EXPLORER_README.md [Original guide]

📁 Source Code:
├── src/aixn/explorer_backend.py      [Main engine (1400+ LOC)]
├── src/aixn/explorer.py              [Web interface]
└── src/aixn/block_explorer.py        [Local testing]
