...
const store = new Store({
  name: 'aura-wallet-config',
  encryptionKey: 'aura-blockchain-secure-key-2025'
});
      ...
      submenu: [
        {
          label: 'Documentation',
          click: async () => {
            await shell.openExternal('https://github.com/aequitas/aura/wiki');
          }
        },
        {
          label: 'Report Issue',
          click: async () => {
            await shell.openExternal('https://github.com/aequitas/aura/issues');
          }
        },
        { type: 'separator' },
        {
        ...
        { type: 'separator' },
        {
          label: 'About Aura Wallet',
          click: () => {
            dialog.showMessageBox(mainWindow, {
              type: 'info',
              title: 'About Aura Wallet',
              message: 'Aura Desktop Wallet',
              detail: `Version: ${app.getVersion()}\nElectron: ${process.versions.electron}\nChrome: ${process.versions.chrome}\nNode: ${process.versions.node}\n\nCopyright © 2025 Aura Blockchain`
            });
          }
        }
      ]
