...
A secure, cross-platform desktop wallet for the Aura blockchain, built with Electron and React.
...
- **Token Operations**: Send and receive Aura tokens
...
- npm 7 or higher
- Aura blockchain node (for live network)
...
2. Enter recipient address (must start with `aura`)
3. Enter amount in Aura
4. Add optional memo
...
# Production
VITE_API_URL=https://api.aura.network
VITE_WS_URL=wss://rpc.aura.network
```
...
- **Solution**: Verify your Aura node is running and accessible
...
# Check logs
# macOS: ~/Library/Application Support/Aura Wallet/logs
# Windows: %APPDATA%/Aura Wallet/logs
# Linux: ~/.config/Aura Wallet/logs
```
...
2. Or manually delete:
   - macOS: `~/Library/Application Support/aura-wallet-config.json`
   - Windows: `%APPDATA%/aura-wallet-config.json`
   - Linux: `~/.config/aura-wallet-config.json`
...
- **Documentation**: [GitHub Wiki](https://github.com/aequitas/aura/wiki)
- **Issues**: [GitHub Issues](https://github.com/aequitas/aura/issues)
- **Discussions**: [GitHub Discussions](https://github.com/aequitas/aura/discussions)
