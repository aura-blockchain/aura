...
A secure, production-ready React Native mobile wallet for the Aura blockchain, supporting both iOS and Android platforms.
...
- **Send & Receive**: Send Aura tokens to any address, receive via QR code
...
- **Balance Tracking**: Real-time balance updates from Aura blockchain
...
Or open `ios/AuraWallet.xcworkspace` in Xcode and run.
...
The default chain ID is `aura-1`. To change it, edit `src/services/PawAPI.js`:
...
- **DEX Module** (`/aura/dex/v1/*`): Trading pools, swaps
- **Oracle Module** (`/aura/oracle/v1/*`): Price feeds
...
#### "Unable to connect to Aura node"

- Ensure the Aura blockchain node is running
...
1. Open `ios/AuraWallet.xcworkspace` in Xcode
...
MIT License - Part of the Aura Blockchain Project
