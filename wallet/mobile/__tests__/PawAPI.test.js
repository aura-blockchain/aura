...
describe('PawAPI Service', () => {
  ...
  describe('Transactions', () => {
    ...
    test('should return empty array when no transactions', async () => {
      ...
      const result = await PawAPI.getTransactionsByAddress('aura1test');
  ...
  describe('DEX', () => {
    ...
    test('should get specific pool', async () => {
      const poolId = '1';
      const mockPool = {
        pool: {id: poolId, token_a: 'uaura', token_b: 'uatom'},
      };
  ...
  describe('Staking', () => {
    ...
    test('should get rewards', async () => {
      ...
      const mockRewards = {
        rewards: [
          {validator_address: 'auravaloper1test', reward: [{denom: 'uaura', amount: '100'}]},
        ],
        total: [{denom: 'uaura', amount: '100'}],
      };
